...
class ClimateDataPointMapperUnitTests {
    ...
    class MapTo {
        ...
        void mapsAllFields() {
            OffsetDateTime now = LocalDateTime.of(2024, 6, 15, 14, 30, 0).atZone(ZoneId.systemDefault()).toOffsetDateTime();
        ...
        void mapsZeroValues() {
            ClimateStats entity = ClimateStats.builder()
                    .date(LocalDateTime.of(2024, 1, 1, 0, 0).atZone(ZoneId.systemDefault()).toOffsetDateTime())
                    .tempVal(0)
                    .humVal(0)
                    .pollVal(0)
                    .build();
        ...
        void preservesExactTimestamp() {
            OffsetDateTime preciseTime = LocalDateTime.of(2024, 6, 15, 14, 30, 45, 123456789).atZone(ZoneId.systemDefault()).toOffsetDateTime();
    ...
    class MapFrom {
        ...
        @DisplayName("maps all fields correctly")
        void mapsAllFields() {
            OffsetDateTime now = LocalDateTime.of(2024, 6, 15, 14, 30, 45, 0).atZone(ZoneId.systemDefault()).toOffsetDateTime();
        ...
        void truncatesTemperatureNotRounds() {
            ClimateDataPointDTO dto = new ClimateDataPointDTO(
                    LocalDateTime.of(2024, 1, 1, 0, 0).atZone(ZoneId.systemDefault()).toOffsetDateTime(), 22.9, 50.0, 300);
        ...
        void truncatesHumidityNotRounds() {
            ClimateDataPointDTO dto = new ClimateDataPointDTO(
                    LocalDateTime.of(2024, 1, 1, 0, 0).atZone(ZoneId.systemDefault()).toOffsetDateTime(), 20.0, 55.9, 300);
        ...
        void truncatesNegativeTemperature() {
            ClimateDataPointDTO dto = new ClimateDataPointDTO(
                    LocalDateTime.of(2024, 1, 1, 0, 0).atZone(ZoneId.systemDefault()).toOffsetDateTime(), -10.9, 50.0, 300);
        ...
        void mapsZeroValues() {
            ClimateDataPointDTO dto = new ClimateDataPointDTO(
                    LocalDateTime.of(2024, 1, 1, 0, 0).atZone(ZoneId.systemDefault()).toOffsetDateTime(), 0.0, 0.0, 0);
        ...
        void doesNotSetId() {
            ClimateDataPointDTO dto = new ClimateDataPointDTO(
                    LocalDateTime.of(2024, 1, 1, 0, 0).atZone(ZoneId.systemDefault()).toOffsetDateTime(), 20.0, 50.0, 300);
