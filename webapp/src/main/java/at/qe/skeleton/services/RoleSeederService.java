...
public class RoleSeederService {
    ...
    public void loadRoles() {
        ...
        Map<String, Set<Permission>> rolePermissions = Map.of(
                ...
                "SYSADMIN", Set.of(Permission.CAN_MANAGE_USERS, Permission.CAN_MANAGE_BUILDING_STRUCTURE, Permission.CAN_MANAGE_DEVICES, Permission.CAN_GET_RASPBERRY_CONFIG, Permission.CAN_VIEW_OCCUPANCY, Permission.CAN_MANAGE_TIPS),
                "HIGHER_MANAGER", Set.of(Permission.CAN_VIEW_COMPANY_AGGR, Permission.CAN_VIEW_VIOLATIONS_PER_DEPARTMENT),
                "DEPARTMENT_MANAGER", Set.of(Permission.CAN_VIEW_OWN_DEPARTMENT_WARNINGS, Permission.CAN_VIEW_OWN_DEPARTMENT_MEASURES, Permission.CAN_VIEW_ABSENCE_VIEW, Permission.CAN_MANAGE_ABSENCES, Permission.CAN_MANAGE_OWN_ABSENCE),
