    ...
    return (
        <div className="table-container">
            <DataTable
                value={rooms}
                {...defaultTableProps}
                className="room-list-table table-scroll"
            ...
            >
                ...
                <Column field="type" header="Type" sortable className="mobile-hide" headerClassName="mobile-hide" />
                <Column field="co2" header="CO₂" />
                <Column field="temp" header="Temp" />
                <Column field="humidity" header="Humidity" />
                <Column header="Status" body={statusTemplate} style={{ width: '5rem', textAlign: 'center' }} />
