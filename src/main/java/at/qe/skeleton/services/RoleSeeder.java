...
public class RoleSeeder implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private void loadRoles() {
        ...
        Map<String, Set<Permission>> rolePermissions = Map.of(
                ...
                "DEPARTMENT_MANAGER", Set.of(Permission.CAN_VIEW_OWN_DEPARTMENT_LIMITS_VIOLATION, Permission.CAN_VIEW_OWN_DEPARTMENT_MEASURES, Permission.CAN_VIEW_ABSENCE_VIEW),
