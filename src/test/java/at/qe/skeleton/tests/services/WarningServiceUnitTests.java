...
class WarningServiceUnitTests {
    ...
    @Nested
    @DisplayName("getActiveWarningsForRoom")
    class GetActiveWarningsForRoom {
        ...
        void returnsActiveForRoom() {
            ...
            List<WarningDTO> result = service.getActiveWarningsForRoom(roomId);
        ...
        void returnsEmptyForCleanRoom() {
            ...
            assertThat(service.getActiveWarningsForRoom(roomId)).isEmpty();
        }
    }
    ...
    class GetViolationLog {
        ...
        void returnsMixed() {
            ...
            List<WarningDTO> result = service.getViolationLog(roomId);
        ...
        void returnsEmptyForCleanRoom() {
            ...
            assertThat(service.getViolationLog(roomId)).isEmpty();
        }
    }
}
